...
public class ProcessDefine {
    ...
    public ProcessDefine(String id, Integer rev, String category, String name, String key, Integer version, String deploymentId, String resourceName, String dgrmResourceName, String description, Byte hasStartFormKey, Integer suspensionState, String tenantId) {
        this.id = id;
        this.rev = rev;
